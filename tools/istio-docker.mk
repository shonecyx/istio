...
DOCKER_TARGETS ?= docker.pilot docker.proxyv2 docker.istioctl docker.install-cni
...
docker.proxyv2: BUILD_ARGS=--build-arg proxy_version=istio-proxy:${PROXY_REPO_SHA} --build-arg istio_version=${VERSION} --build-arg BASE_VERSION=${BASE_VERSION} --build-arg SIDECAR=${SIDECAR} --build-arg TAP_AGENT_VERSION=${TAP_AGENT_VERSION}
...
docker.proxyv2: ${ISTIO_ENVOY_BOOTSTRAP_CONFIG_DIR}/eBay_Root_CA.crt
docker.proxyv2: ${ISTIO_ENVOY_BOOTSTRAP_CONFIG_DIR}/raptor_envoy_bootstrap.json
